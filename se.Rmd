...
For each TRM TAZ, a Triad TAZ covers a portion of the TRM TAZ. That percentage is the 'share' reported below for a sample of TAZs. TRM G2 TAZ 2959 is comprised of two separate Triad TAZs, 4007 and 4299. 
...
```
  ...
  The final output can be seen here. A script is available to process any updated Triad SE data into the same format for Alamance County TAZs for the TRM G2 or future enhancements. 
...
path="C:/Users/JacobFo/OneDrive - City of Durham/GitHub/University_Location_Data/Triad-TRMG2-Conversion"

library(writexl)

write_xlsx(alamance_df)
```
